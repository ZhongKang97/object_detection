...
class TestOptions(BaseOptions):
    def __init__(self):
        ...
        self.parser.add_argument('--trained_model', default='fill_on_your_own', type=str)
        ...
        self.parser.add_argument('--top_k', default=300, type=int, help='The Maximum number of box preds to consider in NMS.')
