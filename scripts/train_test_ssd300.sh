...
# other iterations
CUDA_VISIBLE_DEVICES=3 python eval.py --experiment_name=renew_300_new_scale \
--trained_model=ssd300_0712_iter_120100.pth --ssd_dim=300 --conf_thresh=0.005 --top_k=300 --nms_thresh=0.45

CUDA_VISIBLE_DEVICES=3 python eval.py --experiment_name=renew_300_new_scale \
--trained_model=ssd300_0712_iter_100100.pth --ssd_dim=300 --conf_thresh=0.005 --top_k=300 --nms_thresh=0.45

CUDA_VISIBLE_DEVICES=3 python eval.py --experiment_name=renew_300_new_scale \
--trained_model=ssd300_0712_iter_80100.pth --ssd_dim=300 --conf_thresh=0.005 --top_k=300 --nms_thresh=0.45
